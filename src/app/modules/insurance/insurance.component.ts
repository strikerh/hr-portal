...
@Component({
  ...
  standalone: true,
  imports: [MatIcon, MatButton, MatTableModule, NgIf, DatePipe, ViewInsuranceComponent],
...
showAlert(message) {
  ...
  constructor(private sidePageSerivce:SidePageService,private api:InsuranceApiService,private view:ViewRequestService,private dialog: MatDialog,private snackBar: MatSnackBar,private reload:AfterCloseSidePageService){}
ngOnInit(): void {
