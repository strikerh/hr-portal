...
@Component({
  ...
  styleUrl: './filter-insurance.component.scss'
})
export class FilterInsuranceComponent {
 filterForm: FormGroup;
    requests: any[];
    readonly data: SidePageInfo<FilterInsuranceComponent> = inject(SIDE_PAGE_DATA);
    readonly refs: SidePageRef<FilterInsuranceComponent> = inject(SIDE_PAGE_REF);
